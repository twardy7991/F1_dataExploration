from utils import TelemetryProcessing, FuelProcessing, DTWComputations, AccelerationComputations
import pandas as pd
from utils import FuelProcessing
...
class RaceTransformer:
    ...
    def build_session_dataset(self, gp_name : str, race_session : Session, quali_session : Session, race_telemetry : Telemetry, fuel_start : int = 100) -> pd.DataFrame:
