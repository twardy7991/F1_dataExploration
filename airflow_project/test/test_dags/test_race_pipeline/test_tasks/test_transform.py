...
def test_transform(mocker : MockerFixture, temp_dir):
    ...
    def xcom_pull_side_effect(*, task_ids=None, key=None, **_):
        xcom_map = {
            ("extract", "quali_data_file") : "airflow_/test/data/Bahrain Grand Prix/2023_Bahrain Grand Prix_quali_data.parquet",
            ("extract", "quali_telemetry_file") : "airflow_/test/data/Bahrain Grand Prix/2023_Bahrain Grand Prix_quali_telemetry.parquet",
            ("extract", "race_data_file") : "airflow_/test/data/Bahrain Grand Prix/2023_Bahrain Grand Prix_race_data.parquet",
            ("extract", "race_telemetry_file") : "airflow_/test/data/Bahrain Grand Prix/2023_Bahrain Grand Prix_race_telemetry.parquet",
        }
    ...
    correct_list = os.listdir("airflow_/test/data/processed/Bahrain Grand Prix")
    created_list = os.listdir(temp_dir + "/2023/Bahrain Grand Prix")
    
    assert created_list == correct_list
    
    correct_parq = pd.read_parquet("airflow_/test/data/processed/Bahrain Grand Prix/" + correct_list[0])    
